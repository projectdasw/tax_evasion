...
class C(BaseConstants):
    NAME_IN_URL = 'prefilled_corruption17'
    PLAYERS_PER_GROUP = 4
    NUM_ROUNDS = 1
...
def creating_session(subsession: Subsession):
    ...
    returntax = open(__name__ + '/parameter/middle_return.csv', encoding='utf-8-sig')
...
class FinalResults(Page):
    ...
    def before_next_page(player: Player, timeout_happened):
        ...
        if player.round_number == C.NUM_ROUNDS:
            ...
            participant.pay_treatment17 = player_in_selected_round.payoff
